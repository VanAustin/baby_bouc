...
class Comment extends \AppBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'publishedAt', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'valid', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'text', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'book', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'user'];
        }
