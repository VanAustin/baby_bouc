...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lat', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lng', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'collections', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'comments', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'notes', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'bookwishes', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'myfriends', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'friendswithme', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getBookwishes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBookwishes', []);

        return parent::getBookwishes();
    }

    /**
     * {@inheritDoc}
     */
    public function addBookwish(\AppBundle\Entity\Book $book)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBookwish', [$book]);

        return parent::addBookwish($book);
    }

    /**
     * {@inheritDoc}
     */
    public function removeBookwish(\AppBundle\Entity\Book $book)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBookwish', [$book]);

        return parent::removeBookwish($book);
    }
     ...
     * {@inheritDoc}
     */
    public function addMyfriend(\AppBundle\Entity\Friend $friend)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMyfriend', [$friend]);

        return parent::addMyfriend($friend);
    }

    /**
     * {@inheritDoc}
     */
    public function removeMyfriend(\AppBundle\Entity\Friend $friend)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeMyfriend', [$friend]);

        return parent::removeMyfriend($friend);
    }
     ...
     * {@inheritDoc}
     */
    public function addFriendwithme(\AppBundle\Entity\Friend $friend)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addFriendwithme', [$friend]);
     ...
     * {@inheritDoc}
     */
    public function removeFriendwithle(\AppBundle\Entity\Friend $friend)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeFriendwithle', [$friend]);

        return parent::removeFriendwithle($friend);
    }
