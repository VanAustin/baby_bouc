 ...
 */
class Note extends \AppBundle\Entity\Note implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Note' . "\0" . 'note', '' . "\0" . 'AppBundle\\Entity\\Note' . "\0" . 'book', '' . "\0" . 'AppBundle\\Entity\\Note' . "\0" . 'user'];
        }
